...
#ifdef pvTraceGetControlPlaneBuffer
#error "pvTraceGetControlPlaneBuffer should not be defined"
#endif

#ifdef vTraceProcessControlPlaneMessages
#error "vTraceProcessControlPlaneMessages should not be defined"
#endif
